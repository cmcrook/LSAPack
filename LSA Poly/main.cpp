...
int main(int argc, char** argv)
{
	...
	stats << "\t" << std::left << std::setw(5) << "Iter" << " " << std::left << std::setw(15) << "Collision Rate" << " " << std::left << std::setw(11) << "Pf" << " " << std::left << std::setw(15) << "Press" << " " << std::left << std::setw(10) << "Max dR" << std::endl;
	output << stats.str();
	std::cout << stats.str();
	...
	while (b.pf < input.maxpf)	{
		...
		stats.str("");
		stats << "\t" << std::left << std::setw(5) << iteration << " " << std::left << std::setw(15) << std::setprecision(7) << std::scientific << b.collisionrate << " " << std::left << std::setw(10) << std::fixed << b.pf << "  " << std::left << std::setw(15) << std::scientific << b.pressure << " " << std::left << std::setw(10) << b.maxSizeChange << std::endl;
		output << stats.str();
		std::cout << stats.str();
